...
public class RepositorySorter {
    public void printSortedStudents(
        ...
        List<String> sortedStudents = studentsWithMark.entrySet()
                .stream()
                .sorted(comparator)
        ...
        printStudents(studentsWithMark, sortedStudents);
    }

    private void printStudents(HashMap<String, Double> studentsWithMark, List<String> sortedStudents) {
        for (String student : sortedStudents) {
            OutputWriter.printStudent(student, studentsWithMark.get(student));
        }
    }
}
