...
public class Student {
    ...
    public void enrollingCourse (Course course){
    ...
    private double calculateMark(int[] scores) {
        ...
        double percentageOfSolvedExam = Arrays.stream(scores).sum()/(double)(Course.NUMBER_OF_TASK_ON_EXAM*Course.MAX_SCORE_ON_EXAM);
