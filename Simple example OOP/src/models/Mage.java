...
public class Mage extends GameCharacter {
    ...
    private static final double TELEPORT_CHANCE = 0.5;
    ...
    public void attack(GameCharacter other) throws OutOfEnergyException {
        ...
        if (isCritical){
            System.out.println("Critical hit by Mage!");
            damage = damage * 2;
        }
    ...
    public void respond(int damage) {
        boolean hasTeleported = Math.random() < TELEPORT_CHANCE;
        ...
        if (hasTeleported){
            ...
            System.out.println("Successful attack. " + damage + " damage dealth.");
        }
    }
}
